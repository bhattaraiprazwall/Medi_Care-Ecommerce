...
const ImageUploaderField: React.FC<Props> = ({ field, fieldState, multiple }) => {
    ...
    return (
        <div>
            <div
                {...getRootProps()}
                className={`border-1 border-dashed p-6 rounded-md text-center transition-colors duration-300 cursor-pointer ${isDragActive ? 'bg-gray-100 border-blue-400' : 'bg-white border-gray-300'
